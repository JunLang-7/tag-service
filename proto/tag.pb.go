...
const file_tag_proto_rawDesc = "" +
	"\n" +
	"\ttag.proto\x12\x05proto\x1a\fcommon.proto\x1a\x1cgoogle/api/annotations.proto\"=\n" +
	...
	"\x05pager\x18\x02 \x01(\v2\f.proto.PagerR\x05pager2b\n" +
	"\n" +
	"TagService\x12T\n" +
	"\n" +
	"GetTagList\x12\x18.proto.GetTagListRequest\x1a\x16.proto.GetTagListReply\"\x14\x82\xd3\xe4\x93\x02\x0e\x12\f/api/v1/tagsB(Z&github.com/JunLang-7/tag-service/protob\x06proto3"
